...
jQuery(document).ready(function(){
	...
	jQuery('#poststatus,#postphoto').submit(function(){
		...
		var store_code = t.find('#store_code').val();
		var feedback_date = t.find('#feedback_date').val();
		var concern_id = t.find('#concern_id').val();
		var feedback = t.find('#feedback').val();
		jQuery.post(url,{message: msg, store_code, feedback_date, concern_id, feedback},function(data){
